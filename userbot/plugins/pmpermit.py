...
DEFAULTUSER = str(
    ALIVE_NAME) if ALIVE_NAME else "_"
USER_BOT_WARN_ZERO = "`You` **MC** `were spamming my pro master's inbox, henceforth you asshole are blocked by my master's USERBOT.` **Now GTFO** "
...
if Var.PRIVATE_GROUP_ID is not None:
    ...
    async def on_new_private_message(event):
        ...
        USER_BOT_NO_WARN = (
            f"[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id={catid})\n\n"
            "This is auto generated message from Billa security service\n\n"
            f"Hi buddy my master {DEFAULTUSER} haven't approved you yet. so ,"
            "Leave your name,reason and 99999999999 BIllion $ and hopefully you'll get a reply within 9999 light years.\n\n"
            "**Send** `/start` ** so that my master will decide what to do with you.**")
